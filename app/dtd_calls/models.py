...
class Call(models.Model):
    ...
    caller_name = models.CharField(
        verbose_name="Caller Name", max_length=256, null=True
    )
    caller_address = models.CharField(
        verbose_name="Caller Street Address", max_length=256, null=True
    )
    caller_city = models.CharField(
        verbose_name="Caller City", max_length=256, null=True
    )
    caller_state = models.CharField(
        verbose_name="Caller State (2-Letter)", max_length=2, help_text="TN", null=True
    )
    ...
    caller_household_size = models.IntegerField(
        verbose_name="Caller Household Size", null=True
    )
    ...
    call_source = models.TextField(
        verbose_name="How did you hear about the UWMS Relief Call Center?",
        max_length=200,
        choices=[
